    ...
    <section className="min-h-screen flex items-center justify-center bg-[#0b1120] relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10 pt-20">
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed font-light"
        >
        ...
        >
          ...
          <a
            ...
            className="px-8 py-3.5 bg-[#1e2336] text-white font-medium rounded-full transition-all duration-300 hover:bg-[#2a3044] border border-gray-800"
          >
        ...
        >
          <a href={heroData.socialLinks[0].url} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
            <FaGithub size={24} />
          </a>
          <a href={heroData.socialLinks[1].url} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
            <FaLinkedin size={24} />
          </a>
          <a href={heroData.socialLinks[2].url} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
            <FaTwitter size={24} />
          </a>
        </motion.div>
      </div>
