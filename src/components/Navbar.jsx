  ...
  return (
    <nav className="w-full fixed top-0 z-50 px-8 py-6 flex items-center justify-center bg-black transition-colors">
      ...
      <div className="hidden md:flex items-center space-x-8 text-base md:text-lg font-normal text-gray-400 transition-colors">
        ...
        <a href="#education" className="relative hover:text-white transition-all duration-300 after:content-[''] after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[1px] after:bg-white after:transition-all after:duration-300 hover:after:w-full">Education</a>
      ...
      <div className="absolute right-16">
        <a
          ...
          download="Dilsha Jayasekara_CV.pdf"
