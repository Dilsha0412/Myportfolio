...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-[#0b1120] text-gray-300 relative font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative w-64 md:w-72" style={{ height: '420px' }}>
              ...
              {/* Photo card */}
              <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-2xl z-10 border border-gray-700">
                <img
                  src={profileImg}
                ...
                <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#0b1120]/70 to-transparent"></div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {aboutData.stats.map((stat, index) => (
                <motion.div
                  ...
                  className="bg-[#161d2d] border border-gray-800 rounded-xl p-6 text-center shadow-lg hover:-translate-y-1 transition-transform duration-300"
                >
